...
<h3>Enter the following</h3>
	...
	<input type="text" name="ph1" placeholder="Phone number 1" maxlength="10" minlength="10" required>
	<br>
	<input type="text" name="ph2" placeholder="Phone number 2" maxlength="10" minlength="10" value="">
	<br>
